    ...
    public class TaskController {
        ...
        public Map<String, Object> commentInfomation(@PathVariable("task_id") int taskId, @RequestParam(value = "page",defaultValue = "1") int currentPage)
        {
